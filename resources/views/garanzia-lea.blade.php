                    ...
                    <form method="POST" action="{{ route('aggiornaGraficiGaranzia') }}">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-md-6">
                                            <div class="form-group d-flex">
                                                <select id="annoSelezionato" class="form-control mr-2"
                                                    name="annoSelezionato">
                                                    @php
                                                        $annoCorrente = date('Y');
                                                        $annoMinimo = 2023;
                                ...
                                <div class="card shadow-sm border-0">
                                                ...
                                                <div class="col-md-6">
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>{{ $dataView['nome'] }}</td>
                                                                <td>{{ $dataView['ultimoData']->ob10_1_numeratore ?? '0' }}
                                                                </td>
                                                                <td>{{$dataView['ultimoData']->ob10_1_denominatore ?? '0'}}
                                                                </td>
                                                    ...
                                                    <div
                                                        class="legend p-3 border rounded mt-3 {{ $dataView['messaggioCoperturaVaccinale']['class'] }}">
                                                        <strong>{{ $dataView['messaggioCoperturaVaccinale']['text'] }}</strong>
                                                        <p>Punteggio:
                                                            {{ $dataView['messaggioCoperturaVaccinale']['punteggio'] }}
                                                        </p>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>{{$dataView['nome']}}</td>
                                                            <td>{{$dataView['ultimoData']->ob10_2_numeratore ?? '0'}}
                                                            </td>
                                                            <td>{{$dataView['ultimoData']->ob10_2_denominatore ?? '0'}}
                                                            </td>
                                                ...
                                                <div
                                                    class="legend p-3 border rounded mt-3 {{ $dataView['messaggioCoperturaVaccinaleCicloBase']['class'] }}">
                                                    <strong>{{ $dataView['messaggioCoperturaVaccinaleCicloBase']['text'] }}</strong>
                                                    <p>Punteggio:
                                                        {{ $dataView['messaggioCoperturaVaccinaleCicloBase']['punteggio'] }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div style="overflow-x:auto;">
                                            ...
                                            <div
                                                class="legend p-3 border rounded mt-3 {{ $dataView['messaggioVeterinaria']['class'] }}">
                                                <strong>{{ $dataView['messaggioVeterinaria']['text'] }}</strong>
                                                <p>Punteggio:
                                                    {{ $dataView['messaggioVeterinaria']['punteggio'] }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div style="overflow-x:auto;">
                                ...
                                <div
                                    class="legend p-3 border rounded mt-3 {{ $dataView['messaggioAlimenti']['class'] }}">
                                    <strong>{{ $dataView['messaggioAlimenti']['text'] }}</strong>
                                    <p>Punteggio:
                                        {{ $dataView['messaggioAlimenti']['punteggio'] }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="decessiTumoreCP">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <div class="legend p-3 border rounded mt-3 {{ $dataView['messaggioTumoreCP']['class'] }}">
                                        <strong>{{ $dataView['messaggioTumoreCP']['textTumoreCP'] }}</strong>
                                        <p>Punteggio: {{ $dataView['messaggioTumoreCP']['punteggio'] }}</p>
                                    </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <div id="infezioniPostChirurgiche">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <x-chartjs-component :chart="$dataView['chartInfezioniPostChirurgiche']" />
                                </div>
                                <div class="col-md-4 d-flex flex-column align-items-center justify-content-center">
                                    <div class="legend p-3 border rounded">
